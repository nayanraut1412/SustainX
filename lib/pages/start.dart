...
class Start extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      // ),
      body: Padding(
        padding: const EdgeInsets.fromLTRB(0.0, 00.0, 0.0, 00.0),
        child: Center(
          child: Container(
            width:450,
            height: 990,
                                  ...
                                  children: [
                                    ...
                                    Stack(
                                      children: [
                                        ...
                                        Padding(
                                          padding: const EdgeInsets.fromLTRB(0.0, 155.0, 0.0, 0.0),
                                          child: Center(
                                            child: Text(
                                              'To',
                                              style: TextStyle(
                                  ...
                                  Center(
                                    ...
                                    Padding(
                                      padding:  const EdgeInsets.fromLTRB(80.0, 100.0, 0.0, 5.0),
                                        child: Text('Plastics | Paper | Metals | Ewaste', style: TextStyle(fontSize: 15,
                                                fontFamily: 'Poppins',
                                    ...
                                    Padding(
                                      padding:  const EdgeInsets.fromLTRB(170.0, 50.0, 0.0, 5.0),
                                      child: IconButton(
                                        icon: Icon(
                                        ...
                                        onPressed: () {
                                          ...
                                          Navigator.push(
                                            context,
                                            MaterialPageRoute(builder: (context) => Login(index: 0)),
                                          );
                                        },
                                      ),
                                    ),
